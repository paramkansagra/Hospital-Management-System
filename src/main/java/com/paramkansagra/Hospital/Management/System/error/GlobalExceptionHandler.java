...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleAccessDeniedException(AccessDeniedException ignoredEx) {
        ApiError apiError = new ApiError("Access denied: Insufficient permissions", HttpStatus.FORBIDDEN);
        return new ResponseEntity<>(apiError, HttpStatus.FORBIDDEN);
    }

    @ExceptionHandler(Exception.class)
    public ResponseEntity<ApiError> handleGenericsException(Exception ex) {
